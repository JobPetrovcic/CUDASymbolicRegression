...
void init_symbolic_evaluation(pybind11::module &m)
{
    pybind11::enum_<Operator>(m, "Operator", "Enum for symbolic operations", py::arithmetic())
        ...
        .value("TAN", Operator::TAN)
        .value("ARCSIN", Operator::ARCSIN)
        .value("ARCCOS", Operator::ARCCOS)
        .value("ARCTAN", Operator::ARCTAN)
        .value("SINH", Operator::SINH)
        .value("COSH", Operator::COSH)
        .value("TANH", Operator::TANH)
        .value("FLOOR", Operator::FLOOR)
        .value("CEIL", Operator::CEIL)
        .value("LN", Operator::LN)
        .value("LOG10", Operator::LOG10)
        .value("NEG", Operator::NEG)
        .value("INV", Operator::INV)
        .value("CUBE", Operator::CUBE)
        .value("FOURTH", Operator::FOURTH)
        .value("FIFTH", Operator::FIFTH)
