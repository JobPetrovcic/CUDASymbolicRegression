    ...
    size_t n_x, size_t k, int32_t *error_flag_ptr)
{
    ...
    case SINH:
    {
        ...
        int64_t ch0_idx = ch_acc[k][b_global][0];
        scalar_t arg0 = cache_acc[ch0_idx][n_global][b_global];
        scalar_t g_out0 = g_in * cosh_wrapper(arg0); // d/dx sinh(x) = cosh(x)
        gpuAtomicAdd(&grad_cache_acc[ch0_idx][n_global][b_global], g_out0);
        break;
    }
    case COSH:
    {
        ...
        int64_t ch0_idx = ch_acc[k][b_global][0];
        scalar_t arg0 = cache_acc[ch0_idx][n_global][b_global];
        scalar_t g_out0 = g_in * sinh_wrapper(arg0); // d/dx cosh(x) = sinh(x)
        gpuAtomicAdd(&grad_cache_acc[ch0_idx][n_global][b_global], g_out0);
        break;
    }
    case TANH:
    {
        ...
        scalar_t g_out0 = g_in * (static_cast<scalar_t>(1.0) - mul_wrapper(tanh_val, tanh_val)); // d/dx tanh(x) = 1 - tanh^2(x)
        gpuAtomicAdd(&grad_cache_acc[ch0_idx][n_global][b_global], g_out0);
        break;
    }
    case FLOOR:
    ...
    case CUBE:
    {
        ...
        int64_t ch0_idx = ch_acc[k][b_global][0];
        scalar_t arg0 = cache_acc[ch0_idx][n_global][b_global];
        scalar_t g_out0 = g_in * static_cast<scalar_t>(3.0) * mul_wrapper(arg0, arg0); // d/dx x^3 = 3*x^2
        gpuAtomicAdd(&grad_cache_acc[ch0_idx][n_global][b_global], g_out0);
        break;
    }
    case FOURTH:
    {
        ...
        int64_t ch0_idx = ch_acc[k][b_global][0];
        scalar_t arg0 = cache_acc[ch0_idx][n_global][b_global];
        scalar_t g_out0 = g_in * static_cast<scalar_t>(4.0) * cube_wrapper(arg0); // d/dx x^4 = 4*x^3
        gpuAtomicAdd(&grad_cache_acc[ch0_idx][n_global][b_global], g_out0);
        break;
    }
    case FIFTH:
    {
        ...
        int64_t ch0_idx = ch_acc[k][b_global][0];
        scalar_t arg0 = cache_acc[ch0_idx][n_global][b_global];
        scalar_t g_out0 = g_in * static_cast<scalar_t>(5.0) * fourth_wrapper(arg0); // d/dx x^5 = 5*x^4
        gpuAtomicAdd(&grad_cache_acc[ch0_idx][n_global][b_global], g_out0);
        break;
    }
    default:
