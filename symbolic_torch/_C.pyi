...
class ProbabilisticContextFreeGrammar:
    ...
    def __init__(
        ...
        ...
    def sample_infix(self, B: int) -> torch.Tensor:
        ...
    def to_string(self, expressions: torch.Tensor) -> list[str]:
        ...
    def infix_to_prefix(self, expressions: torch.Tensor, verbosity: int = 0) -> torch.Tensor:
        ...
    def infix_to_postfix(self, expressions: torch.Tensor, verbosity: int = 0) -> torch.Tensor:
        ...
    ...
    def prefix_to_infix(self, expressions: torch.Tensor, max_infix_len : int, verbosity: int = 0) -> torch.Tensor:
        ...
    def prefix_to_postfix(self, expressions: torch.Tensor, verbosity: int = 0) -> torch.Tensor:
        ...
    def postfix_to_prefix(self, expressions: torch.Tensor, verbosity: int = 0) -> torch.Tensor:
        ...
    def get_prefix_parent(self, prefix_ops: torch.Tensor, verbosity: int = 0) -> torch.Tensor:
        ...
    def get_postfix_children(self, postfix_ops: torch.Tensor, verbosity: int = 0) -> torch.Tensor:
        ...
